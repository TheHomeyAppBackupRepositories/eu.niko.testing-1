...
exports.initWriteOnlyCapability = exports.initReadOnlyCapability = exports.initReadWriteCapability = exports.readInitialValue = void 0;
...
async function initReadWriteCapability(device, zclNode, capabilityId, cluster, setName, setParser = defaultSetParser, attributeName, reportParser = defaultReportParser, minChange, endpointId) {
    const endpoint = endpointId ?? device.getClusterEndpoint(cluster) ?? 1;
