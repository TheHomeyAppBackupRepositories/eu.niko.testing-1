...
async function initMeteringDevice(device, zclNode, endpointId) {
    if (device.hasCapability('meter_power')) {
        device.log('Initialising meter_power capability');
        await (0, deviceFactor_1.default)(device, zclNode, 'meter_power', zigbee_clusters_1.CLUSTER.METERING, 'meteringFactor', endpointId)
