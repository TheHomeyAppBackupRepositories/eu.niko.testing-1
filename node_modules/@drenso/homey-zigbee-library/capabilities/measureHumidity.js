...
async function initMeasureHumidityDevice(device, zclNode, capabilityId = 'measure_humidity', endpointId) {
    await (0, attributeDevice_1.initReadOnlyCapability)(device, zclNode, capabilityId, zigbee_clusters_1.CLUSTER.RELATIVE_HUMIDITY_MEASUREMENT, 'measuredValue', (value) => {
