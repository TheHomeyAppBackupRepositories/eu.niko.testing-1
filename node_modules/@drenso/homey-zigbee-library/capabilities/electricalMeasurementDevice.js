...
async function initElectricalMeasurementDevice(device, zclNode, endpointId) {
    if (device.hasCapability('measure_voltage')) {
        ...
        await (0, deviceFactor_1.default)(device, zclNode, 'measure_voltage', zigbee_clusters_1.CLUSTER.ELECTRICAL_MEASUREMENT, 'acVoltageFactor', endpointId)
    ...
    if (device.hasCapability('measure_current')) {
        ...
        await (0, deviceFactor_1.default)(device, zclNode, 'measure_current', zigbee_clusters_1.CLUSTER.ELECTRICAL_MEASUREMENT, 'acCurrentFactor', endpointId)
    ...
    if (device.hasCapability('measure_power')) {
        ...
        await (0, deviceFactor_1.default)(device, zclNode, 'measure_power', zigbee_clusters_1.CLUSTER.ELECTRICAL_MEASUREMENT, 'activePowerFactor', endpointId)
