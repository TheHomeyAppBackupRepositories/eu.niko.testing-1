...
async function initDimDevice(device, zclNode, capabilityId = 'dim', maxDimValue = 0xFE, minChange, endpointId) {
    await (0, attributeDevice_1.initReadWriteCapability)(device, zclNode, capabilityId, zigbee_clusters_1.CLUSTER.LEVEL_CONTROL, 'moveToLevelWithOnOff', async (value, opts) => {
        return {
